...
def survival_story():
    ...
    st.markdown("---")
    st.image("forest.jpg", use_column_width=True, caption="Welcome to the Mysterious Forest")
    ...
    if choice == options[0]:
        ...
        st.image("temple.jpg", use_column_width=True, caption="The Ancient Temple")
        ...
        if explore_choice == "A":
            ...
            st.image("treasure.jpg", use_column_width=True, caption="The Hidden Treasure")
            ...
            st.image("wolves.jpg", use_column_width=True, caption="Encounter with Wolves")
        ...
        st.image("shelter.jpg", use_column_width=True, caption="Building a Shelter")
        ...
        st.image("food.jpg", use_column_width=True, caption="Finding Food")
        ...
        if food_choice == "A":
            ...
            st.image("animal.jpg", use_column_width=True, caption="Encounter with a Wounded Animal")
            ...
            st.image("cave.jpg", use_column_width=True, caption="Discovering a Mysterious Cave")
    ...
    if night_choice == night_options[0]:
        ...
        st.image("night.jpg", use_column_width=True, caption="Night in the Forest")
        ...
        st.image("ritual.jpg", use_column_width=True, caption="Discovering a Mysterious Ritual")
